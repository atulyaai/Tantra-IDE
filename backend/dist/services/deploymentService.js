...
export async function deployToAWS(config) {
    try {
...
export async function deployToGitHubPages(config) {
    try {
...
export async function deployProject(config) {
...
export async function detectDeploymentConfig() {
    try {
